...
**20 architecture elements** across **8 layers** (Capabilities, Communications Services, Core Services, COI Services, User Applications, Business Processes, Business Roles, Information Products) — the full pipeline output including all anchors, propagated nodes, and enriched leaves — connected by **18 traced relations**:

```mermaid
flowchart TD
    subgraph Capabilities["🔵 Capabilities"]
        CP(["Capabilities<br/>★ ⚠ 92%"])
        CP_1000(["Capabilities<br/>★ ⚠ 90%"])
        CP_1023(["Communication and Information System Cap…<br/>★ ⚠ 85%"])
    end
    subgraph Communications_Services["🔴 Communications"]
        CO(["Communications Services<br/>★ ⚠ 88%"])
        CO_1000(["Communications Services<br/>★ ⚠ 86%"])
        CO_1011(["Communications Access Services<br/>★ ⚠ 80%"])
        CO_1063(["Transport Services<br/>★ 70%"])
    end
    subgraph Core_Services["🟠 Core Services"]
        CR(["Core Services<br/>★ ⚠ 81%"])
