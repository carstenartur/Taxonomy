...
The repository-owned audit found review evidence for merged head \`${result.headSha}\` on base branch \`${result.baseRef || 'unknown'}\` that arrived too late, remained unresolved, or was not followed by a clean exact-head re-review:
