...
When multi-user workspace isolation is enabled (see [Repository Topology](REPOSITORY_TOPOLOGY.md)), the following access control matrix applies to workspace operations:
