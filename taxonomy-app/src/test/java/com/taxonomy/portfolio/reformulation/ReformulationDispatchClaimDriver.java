    ...
    public static void main(String[] args) throws Exception {
        ...
        try (var app = new SpringApplicationBuilder(TaxonomyApplication.class).run(
            ...
            var service = new ReformulationExecutionService(proposals, app.getBean(FrozenReformulationEngine.class),
                    app.getBean(CrossTaxonomyReconciler.class), app.getBean(LlmProviderConfig.class), executor, app.getBean(ObjectMapper.class), app.getBean(ReformulationRecoveryService.class), app.getBean(ReformulationUsageService.class));
