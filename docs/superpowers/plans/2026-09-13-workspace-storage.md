...
- [x] Relocate only the eleven production and seventeen test/support files and replace their package declarations. Update imports and exact moved-class FQCNs in consumers. A safe mechanical reference mapping is:
