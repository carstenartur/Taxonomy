...
- [x] Document **embedding model pre-download**: step-by-step instructions for downloading `all-MiniLM-L6-v2` for air-gapped deployments, and how to set `TAXONOMY_EMBEDDING_MODEL_DIR` → *Documented in [CONFIGURATION_REFERENCE.md](CONFIGURATION_REFERENCE.md) §Local Embedding Model*
