...
|---|---|---|---|---|---|
| Add a new LLM provider | `taxonomy-extension-api`, `taxonomy-app` | `LlmProviderExtension.java` + `LlmGatewayRegistry.java` | `./mvnw test -pl taxonomy-app -am` | [add-llm-provider](tasks/add-llm-provider.md) | [LLM providers](07-extension-points.md#llm-providers) |
| Add a new export format | `taxonomy-extension-api`, `taxonomy-export`, `taxonomy-app` | `ExportFormatExtension.java` + `ExportFormatExtensionRegistry.java` | `./mvnw test -pl taxonomy-export -am` | [add-export-format](tasks/add-export-format.md) | [Export formats](07-extension-points.md#export-formats) |
