...
- **Zentralisierte Benutzerverwaltung** — keine separate Benutzerdatenbank erforderlich
- **SSO/SLO-Unterstützung** — Single Sign-On und Single Logout über Anwendungen hinweg
