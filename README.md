...
| **CO** → CO-1000 → CO-1063 → **CO-1050** Transit Services | 88% | 55% | Transport layer for data exchange |
| **CR** → CR-1000 → **CR-1047** Infrastructure Services | 81% | 75% | Infrastructure supporting the platform |
| **UA** → UA-1000 → **UA-1015** Air Applications | 74% | 68% | Dashboard application layer |
| **BP** → BP-1000 → **BP-1327** Enable | 71% | 65% | Business process support |
...
**Interactive views** — the same result rendered in the web UI:
