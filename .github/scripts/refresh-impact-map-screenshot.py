...
elif first_workbench_capture in content:
    path.write_text(
        content.replace(first_workbench_capture, complete_workbench_capture, 1),
        encoding="utf-8",
    )
elif legacy in content:
    path.write_text(
        content.replace(legacy, complete_workbench_capture, 1),
        encoding="utf-8",
    )
else:
